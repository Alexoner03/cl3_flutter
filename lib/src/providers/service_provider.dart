...
import 'package:cl3_seccion1_ortizvargas_alexander/src/models/servicioBe_model.dart';
...
class ServiceProvider extends ChangeNotifier {
  ...
  String _url = "movilesii202022.somee.com";
  final _headers = {
    'Accept': 'application/json'
  };

  Future<List<Servicio>> getServicesByName(String nombreCliente) async {
    final uri = Uri.http(_url, '/Servicios/Listar',{
    ...
    final uri = Uri.http(_url, '/Servicios/RegistraModifica',{
      "Accion" : "N",
      "CodigoServicio": "0",
